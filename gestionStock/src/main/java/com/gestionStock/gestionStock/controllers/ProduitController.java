...
//			produitDao.save(produit);
	...
	public Produit updateProduit(@RequestBody Produit produit) {
		...
		try {
//			produitDao.save(produit);
			Produit p = produitDao.getById(produit.getProduitID());
			System.out.println("##### dans saveProduit == " + p.toString());
			p.setProduitDescription(produit.getProduitDescription());
			applicationManager.update(produit);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
